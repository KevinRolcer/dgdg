...
<section class="wa-totp-page tm-page tm-shell app-density-compact">
    <div class="tm-shell-main {{ !empty($needsSetup) ? 'wa-totp-main-split' : '' }}">
        <div class="wa-totp-card">
            ...
            <form id="waTotpForm" method="POST" action="{{ route('whatsapp-chats.admin.totp.post') }}" autocomplete="off">
                ...
                <div class="{{ !empty($needsSetup) ? 'wa-totp-split-layout' : '' }}">
                        ...
                        <div class="wa-totp-split-left">
                            <div class="wa-totp-section">
                                ...
                                <p class="wa-totp-section-desc">
                                    Abre Google Authenticator y escanea el código. Si no puedes usar la cámara, añade la cuenta con la clave.
                                </p>
                                <div class="wa-totp-qr-stack">
                    ...
                    <div class="{{ !empty($needsSetup) ? 'wa-totp-split-right' : '' }}">
                        <div class="wa-totp-section">
                            <h2 class="wa-totp-section-title">
